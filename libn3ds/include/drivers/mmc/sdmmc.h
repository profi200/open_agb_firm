...
enum
{
	...
	SDMMC_ERR_INITIALIZED    =  2u, // Card is already initialized.
	...
	SDMMC_ERR_SET_CLR_CD     = 14u, // SET_CLR_CARD_DETECT CMD error.
	SDMMC_ERR_SET_BUS_WIDTH  = 15u, // Error on switching to a different bus width.
	SDMMC_ERR_SWITCH_HS      = 16u, // Error on switching to high speed mode.
	SDMMC_ERR_SET_BLOCKLEN   = 17u, // SET_BLOCKLEN CMD error.
	...
	SDMMC_ERR_WRITE_PROT     = 22u  // The card is write protected (write protection slider).
};
