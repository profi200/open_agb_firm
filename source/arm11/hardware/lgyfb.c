...
#define REG_LGYFB_TOP_V_ARRAY     ((vu32 (*)[8])(LGYFB_TOP_REGS_BASE + 0x240)) // 6 * 8 regs.
...
#define REG_LGYFB_TOP_H_ARRAY     ((vu32 (*)[8])(LGYFB_TOP_REGS_BASE + 0x340)) // 6 * 8 regs.
...
#define REG_LGYFB_BOT_V_ARRAY     ((vu32 (*)[8])(LGYFB_BOT_REGS_BASE + 0x240)) // 6 * 8 regs.
...
#define REG_LGYFB_BOT_H_ARRAY     ((vu32 (*)[8])(LGYFB_BOT_REGS_BASE + 0x340)) // 6 * 8 regs.
