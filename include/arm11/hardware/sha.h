...
#define REGs_SHA_FIFO  ((vu32*)(IO_MEM_ARM11_ONLY + 0x101000)) // INFIFO is in the DMA region.
...
static_assert(offsetof(Sha, hash) == 0x40, "Error: Member hash of Sha is not at offset 0x40!");
